...
| `/` | Open command picker |
| `@` | Open file picker |
| `Ctrl+G` | Toggle [git diff view](/wisp/git-diff/) |
...
| Command | Description |
|---------|-------------|
| `/clear` | Start a new [session](/wisp/sessions/) |
| `/settings` | Open the [settings overlay](/wisp/settings/) |
| `/resume` | Resume a previous [session](/wisp/sessions/) |
