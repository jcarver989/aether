...
use crate::llm::openai_compatible::types::{ChatCompletionStreamResponse, ToolCallDelta};
use crate::llm::{LlmError, LlmResponse, LlmResponseStream, Result, ToolCallRequest};
...
mod tests {
    use super::*;
    use crate::llm::openai_compatible::types::{
