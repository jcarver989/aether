...
use aether::llm::{LlmProvider, ChatRequest, ChatMessage, ChatResponse, ToolCall, StreamChunk, StreamChunkStream, ChatStream};
...
async fn test_multiple_tool_calls_streaming() -> Result<()> {
    let chunks = vec![
        ...
        StreamChunk::ToolCallComplete { id: "call_1".to_string() },
        StreamChunk::ToolCallStart { 
            id: "call_2".to_string(), 
        ...
        StreamChunk::ToolCallComplete { id: "call_2".to_string() },
        StreamChunk::Done,
    ];
...
async fn test_streaming_chunk_serialization() -> Result<()> {
    ...
    for chunk in chunks {
        ...
        match (&chunk, &deserialized) {
            ...
            (StreamChunk::ToolCallStart { id: id1, name: name1 }, 
             StreamChunk::ToolCallStart { id: id2, name: name2 }) => {
                assert_eq!(id1, id2);
                assert_eq!(name1, name2);
            },
            (StreamChunk::ToolCallArgument { id: id1, argument: arg1 }, 
             StreamChunk::ToolCallArgument { id: id2, argument: arg2 }) => {
                assert_eq!(id1, id2);
                assert_eq!(arg1, arg2);
            },
